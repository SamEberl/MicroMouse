...
//file global
 ...
 static long rotationCount1 = 0;
 static long rotationCount2 = 0;
 static int8_t velocity_left = 0;
 static int8_t velocity_right = 0;
...
int8_t getVelocityInCountsPerSample_1()
{
    ...
    _NSTDIS=0;
    velocity=(int8_t)(currentPosition-oldPosition);
...
int8_t getVelocityInCountsPerSample_2()
{
    static long oldPosition = 0;
    long currentPosition;
    int8_t velocity;
...
void motorEncoder_10ms(void) {
    velocity_left = getVelocityInCountsPerSample_2();
    velocity_right = getVelocityInCountsPerSample_1();
}

errorCode getMororRightVelocityData(uint8_t *data){
    data[0] = velocity_right;
    return OK;
}

errorCode getMororLeftVelocityData(uint8_t *data){
    data[0] = velocity_left;
    return OK;
}
